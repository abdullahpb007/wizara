            ...
            <section className="saas-tools ptb-100 bg-gray">
                <div className="container">
                    <div className="section-title">
                        <h2>WHY WIZARA? AND HOW?</h2>
                        <div className="bar"></div>
                        <p>WiZARA is a trusted software product engineering and Process Automation
across the globe. What distinguishes us from the rest is our ability to look beyond technologies and deliver innovative and progressive solutions. We innovate with latest technologies, design approaches and development methodologies to build cutting edge software products. Experience our all new holistic approach to software engineering.</p>
                    </div>
